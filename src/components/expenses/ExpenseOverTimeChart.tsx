...
export default function ExpenseOverTimeChart({
  ...
  return (
    <div className="relative col-span-1 flex h-full min-h-100 flex-col gap-5 rounded-xl border border-gray-200 bg-white p-5 shadow-sm md:col-span-2 lg:col-span-3">
      {isLoading && (
      ...
      {/* CHART CONTENT */}
      {chartData.length > 0 ? (
        <div className="relative mt-2 min-h-62.5 w-full flex-1">
        ...
        <div className="flex min-h-62.5 flex-1 flex-col items-center justify-center gap-3 text-gray-500">
